...
public partial class CriterionParser : Antlr.Runtime.Parser
{
	...
	public CriterionSet getCriteria()
	{
		...
		try { DebugEnterRule(GrammarFileName, "getCriteria");
		DebugLocation(31, 0);
		try
		{
	...
	private void criterion()
	{
		...
		TraceIn("criterion", 2);
		try { DebugEnterRule(GrammarFileName, "criterion");
	...
	private void fieldValue()
	{
		...
		try { DebugEnterRule(GrammarFileName, "fieldValue");
		DebugLocation(37, 38);
		try
		{
	...
	private void booleanModifier()
	{
		...
		try { DebugEnterRule(GrammarFileName, "booleanModifier");
		DebugLocation(39, 26);
		try
		{
	...
	private void fieldValueModifier()
	{
		...
		try { DebugEnterRule(GrammarFileName, "fieldValueModifier");
